...
Scope {
    ...
    Process {
        ...
        stdout: SplitParser {
            ...
            onRead: data => root.registry._slotStdout(root.slotIndex, root._requestId, data)
        }
        ...
        onExited: (exitCode, exitStatus) => { // qmllint disable signal-handler-parameters
            ...
            root._clear();
            root.registry._slotExited(root.slotIndex, requestId, exitCode, Number(exitStatus), suppressionReason);
        }
        onRunningChanged: {
