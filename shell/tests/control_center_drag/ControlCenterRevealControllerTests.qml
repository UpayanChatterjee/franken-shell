...
ShellRoot {
    ...
    function run() {
        ...
        root.check(!controller.release(), "vertical gesture settles closed");
        ...
        root.check(!controller.release(), "insufficient motion closes");
        ...
        root.check(controller.release(), "release settles open from the last committed pointer sample");
        root.check(controller.state === "settlingOpen" && root.settleTarget === 1, "distance gesture settles open");
        root.check(!controller.cancelPointerGesture("pointerCancelled") && controller.state === "settlingOpen", "late handler cancellation cannot reverse a committed release");
        ...
        root.check(controller.release(), "inward velocity opens below distance threshold");
        ...
        root.check(!controller.release(), "reversed gesture settles closed");
        ...
        root.check(controller.cancelPointerGesture("pointerCancelled"), "active drag can be cancelled");
        ...
        root.check(!controller.release(), "sufficient outward distance requests closed settle");
